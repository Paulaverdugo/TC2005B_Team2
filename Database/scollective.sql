...
CREATE TABLE PLAYER_TYPES (
    ...
    gadgets SMALLINT UNSIGNED NOT NULL,
    PRIMARY KEY (id_ptypes), 
    CONSTRAINT `fk_PLAYERTYPE_GADGET` FOREIGN KEY (gadgets) REFERENCES GADGET(id_gadget) ON DELETE RESTRICT ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
